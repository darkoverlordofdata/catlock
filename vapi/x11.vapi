...
[CCode (gir_namespace = "xlib", gir_version = "2.0", cprefix = "", lower_case_cprefix = "", cheader_filename = "X11/Xlib.h,X11/Xatom.h,X11/Xutil.h,X11/Xregion.h,X11/xpm.h,X11/Xft/Xft.h")]
namespace X {
...
struct _FcCharSet {
	...
	*/
	...
	[SimpleType]
	[CCode (cname = "FcRef", has_type_id = false)]
	public struct FcRef {
		public long count;
	}

	[CCode (cname = "FcPattern")]
	public struct FcPattern {
		public int		    num;
		public int		    size;
		//  public intptr_t		elts_offset;
		public long			elts_offset;
		public FcRef	    ref_count;
	}

	[CCode (cname = "FcCharSet")] 
	public struct FcCharSet {
		public FcRef	    ref_count;	/* reference count */
		public int		    num;		/* size of leaves and numbers arrays */
		//  public intptr_t	    leaves_offset;
		//  public intptr_t	    numbers_offset;
		public long	    	leaves_offset;
		public long	    	numbers_offset;
	...
	public struct FtFont {
		...
		public FcCharSet  	*charset;
		public FcPattern   	*pattern;
	}
	
	//  [SimpleType]
	//  [CCode (cname = "XftDraw", has_type_id = false)]
	//  public struct FtDraw {
	//  }

	[Compact]
	//  [CCode (cname = "XftDraw", free_function = "XftDrawDestroy")]
	[CCode (cname = "XftDraw", free_function = "")]
	public class FtDraw {
	...
	[SimpleType]
	[CCode (cname = "XRenderColor", has_type_id = false)]
	...
	[SimpleType]
	[CCode (cname = "XftColor", has_type_id = false)]
	...
	public class Display {
		...
		public Status alloc_color(Colormap colormap, Color *screen_in_out);

		[CCode (cname = "XAllocNamedColor")]
		public Status alloc_named_color(Colormap colormap, string color_name, Color *screen_def_return, Color *exact_def_return);

		[CCode (cname = "XftColorAllocValue")]
		public bool alloc_color_value(Visual visual, Colormap cm, RenderColor *color, FtColor *result);

		[CCode (cname = "XftColorFree")]
		public void color_free(Visual visual, Colormap cm, FtColor *color);
		
		[CCode (cname = "XCreateBitmapFromData")]
		public Pixmap create_bitmap_from_data(Drawable d, char *data, uint width, uint height);
		...
		[CCode (cname = "XftFontOpenName")]
		public FtFont* font_open_name(int screen, string name);
		// int XFillRectangle(Display *display, Drawable d, GC
		// gc, int x, int y, unsigned int width, unsigned int height);

		[CCode (cname = "XFillRectangle")]
		public int fill_rectangle(Drawable d, GC gc, int x, int y, uint width, uint height);

		//int XDrawString(Display *display, Drawable d, GC gc, int x, int y, char *string, int length);

		[CCode (cname = "XDrawString")]
		public int draw_string(Drawable d, GC gc, int x, int y, char *string, int length);
		...
		public unowned Screen default_screen_of_display ();

		[CCode (cname = "XDisplayWidth")]
		public int width (int screen_number);

		[CCode (cname = "XDisplayHeight")]
		public int height (int screen_number);

		[CCode (cname = "XDefaultDepth")]
		public int default_depth (int screen_number);

		[CCode (cname = "XDefaultScreen")]
		public int default_screen ();

		[CCode (cname = "XDefaultColormap")]
		public int default_color_map (int screen_number);

		[CCode (cname = "XDefaultVisual")]
		public Visual default_visual (int screen_number);

		[CCode (cname = "XDefineCursor")]
		public void define_cursor (Window window, Cursor cursor);
		...
		public int grab_keyboard (Window grab_window, bool owner_events, int pointer_mode, int keyboard_mode, Time rime);
		...
		public int grab_pointer (Window grab_window, bool owner_events, uint event_mask, int pointer_mode, int keyboard_mode, Window confine_to, X.Cursor cursor, int time);
	...
	[CCode (cname = "XLookupString")]
	int lookup_string(KeyEvent *event_struct, char *buffer_return, int bytes_buffer, ulong *keysym_return, void *status_in_out);

	//  [CCode (cname = "XftDrawString8")]
	//  public int draw_string(FtDraw* d, FtColor* color, FtFont* font, int x, int y, char* str, int length);

	//  [CCode (cname = "XftDrawRect")]
	//  public void draw_rect(FtDraw* d, FtColor* color, int x, int y, uint width, uint height);

	//  [CCode (cname = "XftDrawDestroy")]
	//  public void draw_destroy(FtDraw* d);
	...
	public void destroy_window (Display display, Window parent);
	...
	[CCode (cname = "GrabModeAsync")]
	public const ulong GRAB_MODE_ASYNC;

	[CCode (cname = "GrabModeSync")]
	public const ulong GRAB_MODE_SYNC;

	[CCode (cname = "GrabSuccess")]
	public const ulong GRAB_SUCCESS;
	...
	[CCode (cname = "XK_BackSpace")]
	public const ulong K_BackSpace;

	[CCode (cname = "XK_Tab")]
	public const ulong K_Tab;

	[CCode (cname = "XK_Linefeed")]
	public const ulong K_Linefeed;

	[CCode (cname = "XK_Clear")]
	public const ulong K_Clear;

	[CCode (cname = "XK_Return")]
	public const ulong K_Return;

	[CCode (cname = "XK_Pause")]
	public const ulong K_Pause;

	[CCode (cname = "XK_Scroll_Lock")]
	public const ulong K_Scroll_Lock;

	[CCode (cname = "XK_Sys_Req")]
	public const ulong K_Sys_Req;

	[CCode (cname = "XK_Escape")]
	public const ulong K_Escape;

	[CCode (cname = "XK_Delete")]
	public const ulong K_Delete;
	...
	[CCode (cname = "XColor", has_type_id = false)]
	public struct Color {
		public ulong pixel;
		public ushort red;
		public ushort green;
